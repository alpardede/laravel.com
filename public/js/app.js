...
/* harmony import */ var _clipboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./clipboard */ "./resources/js/clipboard.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  __webpack_require__(/*! ./components/accessibility */ "./resources/js/components/accessibility.js");
});
...
var clipboardIcon = "<svg class=\"fill-current h-5 w-5\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 20 20\" fill=\"currentColor\"><path d=\"M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z\"></path><path d=\"M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z\"></path></svg>";
var clipboardCopiedIcon = "<svg fill=\"currentColor\" class=\"fill-current text-white h-5 w-5\" viewBox=\"0 0 20 20\"><path d=\"M9 2a1 1 0 000 2h2a1 1 0 100-2H9z\"></path><path fill-rule=\"evenodd\" d=\"M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm9.707 5.707a1 1 0 00-1.414-1.414L9 12.586l-1.293-1.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z\" clip-rule=\"evenodd\"></path></svg>"; // Copy to Clipboard.

var codeBlocks = document.querySelectorAll('#main-content pre');
codeBlocks.forEach(function (element, key) {
  // Add wrapper to code block.
  var wrapper = document.createElement('div');
  ['relative', 'code-block-wrapper'].forEach(function (value) {
    wrapper.classList.add(value);
  });
  element.parentNode.insertBefore(wrapper, element);
  wrapper.appendChild(element); // Copy to clipboard button.
  ...
  ['md:block', 'hidden'].forEach(function (value) {
...
var skipToContentLink = document.querySelector('#skip-to-content-link');
var mainContentWrapper = document.querySelector('#main-content');
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  return {
    ...
    handleKeydown: function handleKeydown(event) {
      if (event.key === "/" || event.key === "p" && event.metaKey || event.key === "k" && event.metaKey || event.key === "k" && event.ctrlKey) {
...
/* harmony export */   "toSystemMode": () => (/* binding */ toSystemMode)
/* harmony export */ });
...
var toSystemMode = function toSystemMode() {
...
/* harmony import */ var prismjs_components_prism_ini__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! prismjs/components/prism-ini */ "./node_modules/prismjs/components/prism-ini.js");
/* harmony import */ var prismjs_components_prism_ini__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(prismjs_components_prism_ini__WEBPACK_IMPORTED_MODULE_7__);
...
(prismjs_components_prism_core__WEBPACK_IMPORTED_MODULE_0___default().manual) = true; // highlightCode();
...
function highlightCode() {
  _toConsumableArray(document.querySelectorAll('pre code')).forEach(function (el) {
    prismjs_components_prism_core__WEBPACK_IMPORTED_MODULE_0___default().highlightElement(el);
  });
}
...
function setupNavCurrentLinkHandling() {
  ...
  _toConsumableArray(document.querySelectorAll('.docs_sidebar ul')).forEach(function (nav) {
    ...
    var current = nav.querySelector('li a[href="' + (pathLength === 3 ? window.location.pathname + "/installation" : window.location.pathname) + '"]');
...
function replaceBlockquotesWithCalloutsInDocs() {
  _toConsumableArray(document.querySelectorAll('.docs_main blockquote p')).forEach(function (el) {
    ...
    replaceBlockquote(el, /\{(.*?)\}/, function (type) {
      switch (type) {
        case "note":
...
function replaceBlockquote(el, regex, getImageAndColorByType) {
  ...
  if (type) {
    var _getImageAndColorByTy = getImageAndColorByType(type);

    var _getImageAndColorByTy2 = _slicedToArray(_getImageAndColorByTy, 2);

    img = _getImageAndColorByTy2[0];
    color = _getImageAndColorByTy2[1];
    ...
    imageWrapper.classList = "w-20 h-20 mb-6 flex items-center justify-center shrink-0 ".concat(color, " lg:mb-0");
...
function highlightSupportPolicyTable() {
  function highlightCells(table) {
    ...
    Array.from(table.rows).forEach(function (row, rowIndex) {
      if (rowIndex > 0) {
        var cells = row.cells;
        var versionCell = cells[0];
        var bugDateCell = getCellDate(cells[cells.length - 2]);
        var securityDateCell = getCellDate(cells[cells.length - 1]);
  ...
  var table = document.querySelector('.docs_main #support-policy ~ div table:first-of-type');
  ...
  var oldTable = document.querySelector('.docs_main #support-policy ~ table:first-of-type');
...
window.toSystemMode = _components_theme__WEBPACK_IMPORTED_MODULE_11__.toSystemMode;
